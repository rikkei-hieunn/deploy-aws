	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err != nil {
				...
				assert.Equal(t, result.TickSystem.ElementsDefinitionObject, tt.expect.ElementsDefinitionObject)
				assert.Equal(t, result.TickSystem.CommonDefinitionObject, tt.expect.CommonDefinitionObject)
				assert.Equal(t, result.TickSystem.OneMinuteDefinitionObject, tt.expect.OneMinuteDefinitionObject)
