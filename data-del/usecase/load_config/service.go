...
func (s *Service) LoadConfig(ctx context.Context, keiNumber string) error {
	...
	if keiNumber == model.FirstKei {
		tickEndpointPath = s.Config.TickKei1QuoteCodeDefinitionObject
		kehaiEndpointPath = s.Config.KehaiKei1QuoteCodeDefinitionObject
	} else {
		tickEndpointPath = s.Config.TickKei2QuoteCodeDefinitionObject
		kehaiEndpointPath = s.Config.KehaiKei2QuoteCodeDefinitionObject
	}
